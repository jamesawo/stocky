...
public class PermissionSeeds {
	...
	public static final List<Permission> COMPANY_PERMISSIONS = List.of(
			...
			new Permission(COMPANY_CUSTOMER_ACCESS_PAGE_CUSTOMER, COMPANY),
			new Permission(COMPANY_CUSTOMER_ACCESS_ACTION_CUSTOMER_ADD, COMPANY),
			new Permission(COMPANY_CUSTOMER_ACCESS_ACTION_CUSTOMER_UPDATE, COMPANY),
			new Permission(COMPANY_CUSTOMER_ACCESS_ACTION_CUSTOMER_LIST, COMPANY),
			new Permission(COMPANY_CUSTOMER_ACCESS_CUSTOMER_SEARCH, COMPANY),

			new Permission(COMPANY_EMPLOYEE_ACCESS_PAGE_EMPLOYEE, COMPANY),
			new Permission(COMPANY_EMPLOYEE_ACCESS_ACTION_EMPLOYEE_ADD, COMPANY),
			new Permission(COMPANY_EMPLOYEE_ACCESS_ACTION_EMPLOYEE_UPDATE, COMPANY),
			new Permission(COMPANY_EMPLOYEE_ACCESS_ACTION_EMPLOYEE_LIST, COMPANY),
			new Permission(COMPANY_EMPLOYEE_ACCESS_EMPLOYEE_SEARCH, COMPANY),
			
			new Permission(COMPANY_SUPPLIER_ACCESS_PAGE_SUPPLIER, COMPANY),
			new Permission(COMPANY_SUPPLIER_ACCESS_ACTION_SUPPLIER_ADD, COMPANY),
			new Permission(COMPANY_SUPPLIER_ACCESS_ACTION_SUPPLIER_UPDATE, COMPANY),
			new Permission(COMPANY_SUPPLIER_ACCESS_ACTION_SUPPLIER_LIST, COMPANY),
			new Permission(COMPANY_SUPPLIER_ACCESS_SUPPLIER_SEARCH, COMPANY)
	);
