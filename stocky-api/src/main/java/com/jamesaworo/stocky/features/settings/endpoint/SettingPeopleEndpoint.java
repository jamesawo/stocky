...
import com.jamesaworo.stocky.features.settings.data.interactor.setting_people.ISettingPeopleInteractor;
 ...
 */
@RestController
@RequestMapping(value = API_PREFIX + "/setting-people")
@RequiredArgsConstructor
public class SettingPeopleEndpoint {

    private final ISettingPeopleInteractor interactor;
