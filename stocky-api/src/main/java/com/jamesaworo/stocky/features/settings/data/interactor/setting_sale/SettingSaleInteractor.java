...
@Interactor
@AllArgsConstructor
public class SettingSaleInteractor implements ISettingSaleInteractor, Mapper<SettingDto, SettingTax> {
    ...
    @Override
    public SettingDto toRequest(SettingTax model) {
        ModelMapper mapper = new ModelMapper();
        return mapper.map(model, SettingDto.class);
    }

    @Override
    public SettingTax toModel(SettingDto request) {
        ModelMapper mapper = new ModelMapper();
