...
@Interactor
@AllArgsConstructor
public class SettingStockInteractor implements ISettingStockInteractor, Mapper<SettingDto, SettingStock> {
    ...
    @Override
    public SettingDto toRequest(SettingStock model) {
        ModelMapper mapper = new ModelMapper();
        return mapper.map(model, SettingDto.class);
    }

    @Override
    public SettingStock toModel(SettingDto request) {
        ModelMapper mapper = new ModelMapper();
